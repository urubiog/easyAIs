...
def parse_idx(fd):
    """Parse an IDX file, and return it as a list of lists.
    ...
    -------
    data : list
        List of lists with the dimensions and the data in the IDX file
    """
    DATA_TYPES = {
    ...
    # Function to recursively reshape the list
        ...
        if len(shape) == 1:
            ...
            return [
                reshape_list(
                    lst[
                        i
                        * functools.reduce(operator.mul, shape[1:]) : (i + 1)
    ...
    # Reshape list to match dimensions
    reshaped_data = reshape_list(data_list, dimension_sizes)
...
def download_and_parse_mnist_file(fname, target_dir=None, force=False):
    ...
    -------
    data : list
        List with the dimensions and the data in the IDX file
    """
...
def train_images():
    ...
    -------
    train_images : list
        List with the images in the train MNIST database. The first
...
def train_labels():
    ...
    -------
    train_labels : list
        List with the labels 0 to 9 in the train MNIST database.
    """
